...
describe('validateSnippetInput', () => {
  test.each([
    ...
    [
      ...
      {
        title: 'My Snippet',
        codeSnippets: [{ code: 'console.log("Hello, world!");' }],
        tags: ['javascript'],
      },
      [SnippetValidationMessages.MISSING_USER_ID],
    ],
    // Mismatched userId
    [
      1,
    ...
    [
      ...
      [SnippetValidationMessages.MISSING_TITLE],
    ],
    // Missing codeSnippets
    [
      1,
      { userId: 1, title: 'My Snippet', tags: ['javascript'] },
      ['Missing required attribute - codeSnippets'],
    ],
    ...
    [
      1,
      {
        userId: 1,
        title: 'My Snippet',
        codeSnippets: [{ code: 'a'.repeat(10001) }],
        tags: ['javascript'],
      },
      ['The code snippet is too long. Max 10000 allowed'],
    ],
    ...
    expect(() =>
      snippetInputValidator.validateSnippetInput(userId, snippet)
    ).toThrow(SnippetValidationMessages.SNIPPET_NOT_VALID);
    try {
      snippetInputValidator.validateSnippetInput(userId, snippet);
