...
describe('BookmarkFilter Pipe', () => {
  ...
  const initTestBookmarks = function () {
    ...
    const bookmarkExampleTwo: Bookmark = {
      ...
      language: 'en',
      tags: ['node.js', 'graphql', 'expressjs'],
      publishedOn: new Date(),
      sourceCodeURL:
        'https://github.com/CodepediaOrg/graphql-express-crud-demo',
      description:
        'In this blog post I will present the implementation of a GraphQL server API that provides CRUD operations',
      descriptionHtml:
        '<p>In this blog post I will present the implementation of a GraphQL server API that provides CRUD operations</p>',
      userId: 'testUserId',
      public: true,
      likeCount: 0,
      lastAccessedAt: null,
